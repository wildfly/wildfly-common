...
/**
 * Factory provides {@link SchemaFactory} with secure defaults set. Properties not supported generate a warning, but
 ...
 * @since 1.7.0.Final
 */
public class SchemaFactoryUtil {
    /*
    ...
    /**
     * Factory generated with secure defaults for schema language {@code javax.xml.XMLConstants.W3C_XML_SCHEMA_NS_URI}.
     * @return an instance of the SchemaFactory.
     */
    @NotNull
    public static SchemaFactory create() {
        final SchemaFactory instance = SchemaFactory.newInstance(W3C_XML_SCHEMA_NS_URI);
